...
import {getLineAnalyticsToday} from "../../../../util/APIUtils";
import Grid from "@material-ui/core/Grid";
import {CardHeader} from "@material-ui/core";
import CardContent from "@material-ui/core/CardContent";
import Card from "@material-ui/core/Card";
export default class LineAnalytics extends Component{
    ...
    componentDidMount() {
        getLineAnalyticsToday().then(response => this.setState({data: response}));
    }
    ...
    render() {
        return(
                ...
                <Card className="card" style={{height: "100%"}}>
                    <CardHeader className="card-header" title="Live: nach Lines" action={
                        <button type="button" className="btn btn-tool" data-card-widget="remove" onClick={() => this.props.handleRemove("Lines")}><i
